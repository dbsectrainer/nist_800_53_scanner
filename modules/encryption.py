...
class SecureDataHandler:
    ...
    def _load_or_create_keys(self) -> Dict:
        ...
        if os.path.exists(self.keys_file):
            ...
            return {
                ...
                'previous': self.key_storage.unwrap_key(base64.b64decode(keys_data['previous']['key'])) if keys_data.get('previous') else None,
    ...
    def _save_keys(self):
        ...
        if self.keys['previous']:
            keys_data['previous'] = {
                'key': base64.b64encode(self.key_storage.wrap_key(self.keys['previous'])).decode()
            }
    ...
    def encrypt_data(self, data: Union[str, Dict, Any]) -> Dict[str, str]:
        ...
        # Calculate HMAC
        h = hmac.new(self.keys['current'], encrypted_data, hashes.SHA256)
